...
if("TRUE" STREQUAL "TRUE")
  set(plumbing_pub_sub_SOURCE_PREFIX /home/cuddliu/demo02_ws/src/plumbing_pub_sub)
  set(plumbing_pub_sub_DEVEL_PREFIX /home/cuddliu/demo02_ws/devel)
  ...
  set(plumbing_pub_sub_INSTALL_PREFIX /home/cuddliu/demo02_ws/install)
...
if(NOT "/home/cuddliu/demo02_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plumbing_pub_sub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cuddliu/demo02_ws/src/plumbing_pub_sub/${idir}'.  ${_report}")
    endif()
