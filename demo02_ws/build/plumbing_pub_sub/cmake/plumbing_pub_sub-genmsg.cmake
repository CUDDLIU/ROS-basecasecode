...
set(MSG_I_FLAGS "-Iplumbing_pub_sub:/home/cuddliu/demo02_ws/src/plumbing_pub_sub/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/cuddliu/demo02_ws/src/plumbing_pub_sub/msg/Person.msg" NAME_WE)
add_custom_target(_plumbing_pub_sub_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "plumbing_pub_sub" "/home/cuddliu/demo02_ws/src/plumbing_pub_sub/msg/Person.msg" ""
)
...
_generate_msg_cpp(plumbing_pub_sub
  "/home/cuddliu/demo02_ws/src/plumbing_pub_sub/msg/Person.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/plumbing_pub_sub)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/plumbing_pub_sub\")")
  # install generated code
  install(
